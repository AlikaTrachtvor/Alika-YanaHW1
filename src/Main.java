...
import java.util.Scanner;
    ...
    public class Main {
        ...
        public static void battleshipGame() {
            ...
            userAttack(userGuessBoard,compBoard,rowNum,colNum,userShipNum,comShipNum);
        }

        public static int userAttack(char guessBoard[][],char comBoard[][],int n,int m,int userShipNum,int comShipNum){

            System.out.println("Your current guessing board: ");
            printBoard(guessBoard, n, m);
            System.out.println("Enter a tile to attack");
            String userChoice = scanner.nextLine();

            while (!moveCheck(guessBoard, n, m, userChoice.charAt(0), userChoice.charAt(2))) {
                System.out.println("Your current guessing board: ");
                printBoard(guessBoard, n,m);
            }
            if(comBoard[userChoice.charAt(0)][userChoice.charAt(2)]==MISS) {
                System.out.println("That is a miss!");
                guessBoard[userChoice.charAt(0)][userChoice.charAt(2)] = MISS;
            }
            else if(isDrowned(comBoard,n,m,userChoice.charAt(0),userChoice.charAt(2))){
                comShipNum--;
                System.out.println("The computer's battleship has been drowned," +comShipNum+ "more battleships to go!");
                guessBoard[userChoice.charAt(0)][userChoice.charAt(2)] = HIT;
                comBoard[userChoice.charAt(0)][userChoice.charAt(2)] = MISS;
            }
            else{
